...
( function( $ ) {
    ...
    recent_blog_section_lists.forEach(recent_blog_homepage_scroll_preview);

    function recent_blog_homepage_scroll_preview(item, index) {
        ...
        wp.customize.bind('preview-ready', function() {
            ...
            wp.customize.preview.bind(item, function(data) {
                ...
                if (true === data.expanded) {
                    $('html, body').animate({
                        'scrollTop': $('#recent_blog_' + item + '_section').position().top
                    });
                }
            });
