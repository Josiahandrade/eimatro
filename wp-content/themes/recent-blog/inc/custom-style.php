 ...
 * Custom Style
 */
function recent_blog_header_text_style() {

	$site_title_font       = get_theme_mod( 'recent_blog_site_title_font', '' );
	$site_description_font = get_theme_mod( 'recent_blog_site_description_font', '' );
	$header_font           = get_theme_mod( 'recent_blog_header_font', '' );
	$body_font             = get_theme_mod( 'recent_blog_body_font', '' );
	...
	<style type="text/css">
		...
		.site-description {
			color: <?php echo esc_attr( get_theme_mod( 'recent_blog_header_tagline', '#000000' ) ); ?>;
		}
	...
	<?php if ( 'loadmore' === get_theme_mod( 'recent_blog_pagination_type', 'loadmore' ) ) : ?>
...
add_action( 'wp_head', 'recent_blog_header_text_style' );
