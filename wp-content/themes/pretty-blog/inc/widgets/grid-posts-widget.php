 ...
 * Register Widgets
 */
function pretty_blog_register_widgets() {

	register_widget( 'Pretty_Blog_Grid_Posts_Widget' );

}
add_action( 'widgets_init', 'pretty_blog_register_widgets' );


if ( ! class_exists( 'Pretty_Blog_Grid_Posts_Widget' ) ) {
	/**
	 * Adds Pretty Blog Pro Grid Posts Widget.
	 */
	class Pretty_Blog_Grid_Posts_Widget extends WP_Widget {
		...
		public function __construct() {
			$grid_posts_widget = array(
				...
				'description' => __( 'Retrive Posts List Widgets', 'pretty-blog' ),
			);
			parent::__construct(
				'pretty_blog_grid_posts_widget',
				__( 'Adore Widget: Grid Posts Widget', 'pretty-blog' ),
				$grid_posts_widget
			);
		}
		...
		public function form( $instance ) {
			...
			?>
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>"><?php esc_html_e( 'Section Title:', 'pretty-blog' ); ?></label>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'offset' ) ); ?>"><?php esc_html_e( 'Number of posts to displace or pass over:', 'pretty-blog' ); ?></label>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'category' ) ); ?>"><?php esc_html_e( 'Select the category to show posts:', 'pretty-blog' ); ?></label>
